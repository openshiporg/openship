...
export function CartItemSelect({ channel, form, rightSection }) {
  ...
  const fields = form.values.cartItems.map(
    (
  ...
  return (
    <Box mt="md" ref={setReferenceElement}>
      ...
      >
        ...
        {form.values.cartItems.length > 0 ? (
              ...
              <Group spacing={4}>
                ...
                >
                  ...
                  <NumberInput
                    ...
                    {...form.getListInputProps("cartItems", index, "quantity")}
                  />
                  ...
                  <ActionIcon
                    ...
                    variant="light"
                    color="red"
                    onClick={() => form.removeListItem("cartItems", index)}
                    onMouseDown={(event) => event.preventDefault()}
                    sx={{
                      border: `1px solid ${
                        theme.colorScheme === "dark"
