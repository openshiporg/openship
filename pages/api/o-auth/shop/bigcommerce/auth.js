  ...
  try {
    ...
    const bigcommerceResponse = await fetch(
      "https://login.bigcommerce.com/oauth2/token",
      {
        ...
        body: JSON.stringify({
          client_id: process.env.SHOP_BIGCOMMERCE_API_KEY,
          client_secret: process.env.SHOP_BIGCOMMERCE_SECRET,
          code: req.query.code,
          context: req.query.context,
          scope: req.query.scope,
          grant_type: "authorization_code",
          redirect_uri: `${process.env.FRONTEND_URL}/api/o-auth/shop/bigcommerce/auth`,
        }),
      }
    );
