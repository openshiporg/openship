...
export const CartItem = ({
  ...
  return (
    <div className="border p-2 bg-background rounded-sm flex gap-4">
      {item.image && (
        <img
      ...
      <div className="flex flex-col gap-2 justify-between">
        <div className="flex items-center gap-2 self-end">
          ...
          {item.purchaseId && (
            <Badge
              color="zinc"
              className="border text-xs font-medium tracking-wide py-0.5"
            >
              {item.purchaseId}
            </Badge>
          )}
        ...
        {item.error && (
          <Badge
            color="red"
            className="flex flex-wrap gap-1 items-center justify-between border text-xs font-medium tracking-wide uppercase py-0.5 shadow-xs"
          >
