...
test(
  'insertBreak in the middle of the text when there is a break at the end of the text',
  () => {
    const editor = makeEditor(<editor>
      <code>
        <text>
    ...
    editor.insertBreak()
    expect((editor).children[0].children[0].text).toMatchInlineSnapshot(`
      "some text
      more text
      "
    `)
