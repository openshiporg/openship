...
test(
  'pasting a url on a selection spanning multiple blocks replaces the selection with the url',
  () => {
    const editor = makeEditor(<editor>
      <paragraph>
        <text>
...
test(
  'pasting a url on a selection with a link inside replaces the selection with the url',
  () => {
    const editor = makeEditor(<editor>
      <paragraph>
        <text>
