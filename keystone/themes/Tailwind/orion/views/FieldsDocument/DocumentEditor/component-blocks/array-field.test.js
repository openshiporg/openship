...
const list = component({
  preview: props =>
    React.createElement('ul', null, props.fields.children.elements.map((x, i) => {
...
test('child field in nested array', () => {
  ...
  </editor>, { componentBlocks: { list } })
})

test(
  'inserting a break at the end of a child field creates a new item with fresh values',
  () => {
...
test(
  'inserting a break splits the text and uses the values from the first entry',
  () => {
    const editor = makeEditor(<editor>
      <component-block
        component="list"
...
test(
  'inserting a break in an empty child removes the element and inserts a paragraph',
  () => {
    const editor = makeEditor(<editor>
      <component-block
        component="list"
...
test('inserting an item from empty works', () => {
  ...
  (editor.container.querySelector('button[data-insert]')).click()
  expect(editor).toMatchInlineSnapshot(`
    <editor>
      <component-block
        component="list"
...
test('removing an item using the preview props works', () => {
  ...
  (editor.container.querySelector('button[data-remove]')).click()
  expect(editor).toMatchInlineSnapshot(`
    <editor>
      <component-block
        component="list"
