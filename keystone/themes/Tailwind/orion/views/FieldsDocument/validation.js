...
import { isRelationshipData, validateDocumentStructure } from  './structure-validation'
...
export function getValidatedNodeWithNormalizedComponentFormProps(node, componentBlocks, relationships) {
