...
import { getFilteredChannelsWithPlatform, getChannelPlatforms } from "@/features/platform/channels/actions";
...
export async function ChannelsListPage({ searchParams }: PageProps) {
          ...
          <div className="border-gray-200 dark:border-gray-800">
            <div className="px-4 md:px-6 pt-4 md:pt-6 pb-4">
              ...
              <p className="text-muted-foreground">
                <span>Create and manage your sales channels</span>
              </p>
            </div>
          </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground text-sm">
                    {(search !== null) || selectedPlatform
                      ...
                      : "Connect your first sales channel to get started"}
                  </p>
                  {((search !== null) || selectedPlatform) && (
