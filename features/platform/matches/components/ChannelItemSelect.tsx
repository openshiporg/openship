...
import { searchChannelProducts } from '../../orders/actions/orders';
...
interface ChannelItemSelectProps {
  channels: Channel[];
  selectedItems: SelectedChannelItem[];
  onSelectionChange: (items: SelectedChannelItem[]) => void;
  onOpenDrawer?: (product: Product, channel: Channel) => void;
}

export const ChannelItemSelect: React.FC<ChannelItemSelectProps> = ({
  channels,
  selectedItems,
  onSelectionChange,
  onOpenDrawer,
  ...
  const handleAddItem = async (product: Product) => {
    ...
    if (onOpenDrawer) {
      onOpenDrawer(product, selectedChannel);
      return;
    }
    ...
    try {
      ...
      let updatedItems: SelectedChannelItem[];
      ...
      if (existingItemIndex >= 0) {
        ...
        const newItem: SelectedChannelItem = {
          quantity,
  ...
  return (
    ...
    >
      ...
      <CollapsibleContent className="space-y-2">
        {/* Display existing selected channel items - ABOVE search bar */}
        {selectedItems.length > 0 && (
          <div className="space-y-2">
            <h4 className="text-sm font-medium text-blue-600 dark:text-blue-400">Selected Channel Products ({selectedItems.length})</h4>
                ...
                >
                  ...
                  <div className="flex-grow min-w-0">
                    ...
                    <div className="text-xs text-muted-foreground">
                      {item.channel.name} • Qty: {item.quantity}
