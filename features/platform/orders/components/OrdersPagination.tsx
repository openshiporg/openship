...
interface OrdersPaginationProps {
  ...
  renderActions?: (selectedItems: Set<string>) => React.ReactNode;
}

/**
 * Orders-specific Pagination component with custom actions support
 * Based on dashboard Pagination but with renderActions support
 */
