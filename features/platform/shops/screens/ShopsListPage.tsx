...
import { getFilteredShopsWithPlatform, getShopPlatforms } from "@/features/platform/shops/actions";
...
export async function ShopsListPage({ searchParams }: PageProps) {
